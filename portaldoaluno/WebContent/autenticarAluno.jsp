...
<body>
	<%
		 ...
		 */
		//url online rest service
		String urlservice = "http://portalacademico.jelasticlw.com.br/servicos"
				+ "/autenticar/aluno/" + login + "/" + senha;
		...
		/* 
		Comentários para Avaliação do Código: 
			Saída para controle do retorno do webservice via console.
		 */
